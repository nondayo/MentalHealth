library(dplyr)
dat2019 <- read.csv("data/OSMI 2019 Mental Health in Tech Survey Results - OSMI Mental Health in Tech Survey 2019.csv")
dat2020 <- read.csv("data/OSMI 2020 Mental Health in Tech Survey Results .csv")
...
write.csv(dat, file = "eval/MentalHealth_2019_2020.csv", row.names = F)

dat_required <- dat[, c(1:18, 42, 44:53, 60:67)]
write.csv(dat_required, file = "eval/MentalHealth_2019_2020_required.csv", row.names = F)
